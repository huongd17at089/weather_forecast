...
public class LocationResponse {
    ...
    public weather.model.Location getLocationByIp(String ip) throws MalformedURLException, JSONException, IOException {
...
//        String flag = json.get("country_flag").toString();
    ...
    public void setCoordinatesByAddress (Location location) throws IOException, JSONException, UnknownHostException{
